...
const SECTIONS: Section[] = [
  ...
  { id: "volunteer", label: "Volunteer", isDone: () => (resume.volunteer?.length ?? 0) > 0 },
  { id: "education", label: "Education", isDone: () => (resume.education?.length ?? 0) > 0 },
  { id: "awards", label: "Awards", isDone: () => (resume.awards?.length ?? 0) > 0 },
  {
    id: "publications",
    label: "Publications",
    isDone: () => (resume.publications?.length ?? 0) > 0,
  },
